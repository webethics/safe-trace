...
<div class="container">
		...
		<div class="row">	
			<div class="col-md-12">
				<div class="info">
				@if($site_data && $site_data->welcome_text)
					{{$site_data->welcome_text}}
				@else
					Thank you for coming to our restaurant during these trying times. Due to COVID-19 we are required to take your information for public safety measures. We appreciate your understanding and cooperation and hope your family and friends are safe and healthy.
				@endif
					...
					{{ csrf_field() }}
					 ...
					 <div class="form-row">
						<div class="col-md-3 form-group">
							<select class="form-control" name="customer_code[1]">
					   ...
					   <div class="col-md-9 form-group">
							<input type="text" class="form-control" name ="customer_text[1]" placeholder="*Phone:">
							<span class="phone">Example: *Phone (555-555-5555)</span>
							<div class="customer_text.1_error errors"></div>
					   </div>
					</div>
					  <div class="form-group">
						<input type="email" class="form-control" name ="customer_email[1]"  placeholder="*Email:">
						<div class="customer_email.1_error errors"></div>
					  </div>
					  ...
					  <div class="form-group addon-field-btn">
						<a class="add-more add_form_field" href="javascript:void(0)"><i class="fas fa-plus"></i> Additional Guests</a>
					  </div>
						@if($site_data && $site_data->verbiage_text)
							<div class="custom-control custom-checkbox form-group">
								<input type="checkbox" value = "yes" class="custom-control-input" name="loayality_program"  checked="checked" id="customCheck1">
								<label class="custom-control-label" for="customCheck1">{{$site_data->verbiage_text}}</label>
							</div>
						@else
					  ...
					  <!--div class="custom-control custom-checkbox form-group">
						...
						<label class="custom-control-label" for="customCheck1">I would like to be included in your loyalty program</label>
					  </div-->
