				...
				<div class="col-lg-12">
					<div class="box box-primary">
						<div class="box-body">
							...
							{{ Form::open(array('url' => 'email/update', 'method' => 'post','class'=>'profile form-horizontal')) }}
							...
							<div class="form-group col-md-12">
								 <div class="sign-up-btn ">
									<input type="hidden" value="{{$data->id}}" name="email_id" id="email_id" >
									 ...
									 <a href="{{url('emails')}}" name="back" class="loginmodal-submit btn btn-primary" id="profile_back" value="Back" type="submit">Back</a>
								</div>
							</div>
							@endforeach
								  {{ Form::close() }}
